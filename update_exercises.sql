...
SELECT name AS 'Album names', release_date AS 'Albums released before 1980' FROM albums WHERE release_date < '1980';
UPDATE albums
SET release_date = release_date - 100
WHERE release_date < '1980';
SELECT name AS 'Album names', release_date AS 'Updated album release dates' FROM albums WHERE release_date < '1980';
